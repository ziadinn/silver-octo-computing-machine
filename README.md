...
```tsx
// NOTE: You need to replace <INSERT_YOUR_EC2_PUBLIC_IP> with the public IPv4 address of your EC2 instance and have the http:// prefix
...
NOTE: In the resource, you need to replace `${YOUR_BUCKET_NAME}` with the name of your bucket.
